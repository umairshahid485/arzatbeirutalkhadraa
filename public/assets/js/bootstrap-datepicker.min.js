...
!(function (a, b) {
    ...
    j.prototype = {
        ...
        _process_options: function (e) {
            ...
            if (
                (f.startDate !== -1 / 0 && (f.startDate = f.startDate ? (f.startDate instanceof Date ? this._local_to_utc(this._zero_time(f.startDate)) : q.parseDate(f.startDate, h, f.language)) : -1 / 0),
