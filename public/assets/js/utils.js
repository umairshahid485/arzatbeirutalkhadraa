...
*/
    ...
    function Pa(a, b, c, d, e, f) {
        ...
        if (
            ...
            (h = "" + g),
            (l = b.toString()),
            0 == l.lastIndexOf(h, 0) && ((h = new F(l.substring(h.length))), (l = r(c, 1)), (l = new RegExp(y(l, 2))), Qa(h, c, null), (h = h.toString()), (!O(l, b.toString()) && O(l, h)) || 3 == Y(a, b.toString(), c, -1)))
        )
