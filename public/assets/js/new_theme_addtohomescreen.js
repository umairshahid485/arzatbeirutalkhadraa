...
ath.intl = {
	...
	en_us: {
		ios: addhomescreen_msg_ios,
		android: addhomescreen_msg_android
	},
...
ath.Class.prototype = {
	...
	show: function (force) {
		...
		// add the action icon
		message = '<p style="font-weight:bold;color:#5959b7;">'+add_to_homescreen_title+'</p><p class="text-left">' + message.replace(/%icon(?:\[([^\]]+)\])?/gi, function(matches, group1) {
		...
		$(document).off("click",".add-app-btn").on("click",".add-app-btn",function(){
			//$(".add-to-home-opacity").css('opacity',1);
			$(".ath-viewport").css('display', 'block');
		});
		// create the actual message element
		this.element = document.createElement('div');
		this.element.className = 'ath-container ath-' + ath.OS + ' ath-' + ath.OS + (parseInt(ath.OSVersion) || '') + ' ath-' + (ath.isTablet ? 'tablet' : 'phone');
		this.element.style.cssText = 'animation-name: slideup;    animation-delay: 0s;animation-duration: 1s;animation-fill-mode: forwards;animation-timing-function: ease-out;';
		$('.page-begining').addClass('add-to-home-opacity');
	...
	remove: function () {
		...
		$('.page-begining').removeClass('add-to-home-opacity');
	},
