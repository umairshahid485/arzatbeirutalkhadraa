            ...
            (n = (function () {
                function t(t, i) {
                    null == i && (i = {}),
                        ...
                        (this.$wrapper = e("<div>", {
                            class: (function (t) {
                                return function () {
                                    var e;
                                    return (
                                        (e = ["" + t.options.baseClass].concat(t._getClasses(t.options.wrapperClass))),
                        ...
                        (this.$container = e("<div>", { class: "" + this.options.baseClass + "-container" })),
                        (this.$on = e("<span>", { html: this.options.onText, class: "" + this.options.baseClass + "-handle-on " + this.options.baseClass + "-" + this.options.onColor })),
                        (this.$off = e("<span>", { html: this.options.offText, class: "" + this.options.baseClass + "-handle-off " + this.options.baseClass + "-" + this.options.offColor })),
                        (this.$label = e("<span>", { html: this.options.labelText, class: "" + this.options.baseClass + "-label" })),
                        this.$element.on(
                ...
                return (
                    ...
                    (t.prototype.state = function (t, e) {
                        return "undefined" == typeof t
                            ...
                            ? this.$element
                            : (this.options.indeterminate && this.indeterminate(!1), (t = !!t), this.$element.prop("checked", t).trigger("change.bootstrapSwitch", e), this.$element);
                    }),
                    (t.prototype.toggleState = function (t) {
                        return this.options.disabled || this.options.readonly
                            ...
                            : this.$element.prop("checked", !this.options.state).trigger("change.bootstrapSwitch", t);
                    }),
                    (t.prototype.size = function (t) {
                        return "undefined" == typeof t
                            ? this.options.size
                            : (null != this.options.size && this.$wrapper.removeClass("" + this.options.baseClass + "-" + this.options.size),
                                            ...
                                            ? ((t.options.state = o),
                                              ...
                                              n
                                                  ...
                                                  : (t.$element.is(":radio") &&
                                                    ...
                                                    t.$element.trigger("switchChange.bootstrapSwitch", [o])))
                                            : void 0
                                    );
                                };
                            })(this),
