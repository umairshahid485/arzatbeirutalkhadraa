            ...
            return (
                this.each(function () {
                    ...
                    function r(e, t, i) {
                        ...
                        if (
                            (t && ((o = parseInt(M.css("top")) + ((e * parseInt(a.wheelStep)) / 100) * M.outerHeight()), (o = Math.min(Math.max(o, 0), r)), (o = e > 0 ? Math.ceil(o) : Math.floor(o)), M.css({ top: o + "px" })),
                    ...
                    if (("ontouchstart" in window && window.navigator.msPointerEnabled && S.css("-ms-touch-action", "none"), S.parent().hasClass(a.wrapperClass))) {
                        ...
                        H.css(D),
                            ...
                            n(),
                            "bottom" === a.start ? (M.css({ top: S.outerHeight() - M.outerHeight() }), r(0, !0)) : "top" !== a.start && (r(e(a.start).position().top, null, !0), a.alwaysVisible || M.hide()),
                            s();
                    }
                }),
                this
