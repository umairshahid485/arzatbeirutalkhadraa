(function (e, t) {
    ...
    function c(t, s, a) {
        ...
        return (
            a || (a = {}),
            (a = e.extend({ bind: {}, divClass: null, divWrap: "wrap", spanClass: null, spanHtml: null, spanWrap: "wrap" }, a)),
            (i = e("<div />")),
            (r = e("<span />")),
        ...
        A = [
                                ...
                                f ||
                                    ...
                                    e[0].dispatchEvent
                                        ? ((t = document.createEvent("MouseEvents")),
                                          ...
                                          e.is("a") && s && ((a = n(e, "target")), (i = n(e, "href")), a && "_self" !== a ? window.open(i, a) : (document.location.href = i)))
                                        : e.click(),
                                    (f = !1));
                            },
                        }),
            ...
            },
            {
                ...
                apply: function (t, r) {
                    ...
                    var d, f, p, v;
                    return (
                        (d = c(t, r, { divClass: r.fileClass, spanClass: r.fileButtonClass, spanHtml: r.fileButtonHtml, spanWrap: "after" })),
                        (f = d.div),
                        (v = d.span),
            ...
            },
            {
                ...
                apply: function (t, n) {
                    ...
                    return (
                        ...
                        (r = c(t, n, { divClass: n.selectClass, spanHtml: (t.find(":selected:first") || t.find("option:first")).html(), spanWrap: "before" })),
                        (l = r.div),
                        (o = r.span),
                        n.selectAutoWidth
                            ? g(t, function () {
